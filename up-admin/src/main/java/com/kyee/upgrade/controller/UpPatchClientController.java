...
//    @RequiresPermissions("upgrade:patchClient:downloadPatchFile")
    ...
    public AjaxResult downloadPatchFile(String patchId) {
        ...
        return upPatchClientService.downloadPatchFile(patchId);
    }
...
//    @RequiresPermissions("upgrade:patchClient:uploadPatchFile")
    ...
    {
        return upPatchClientService.tempUpgrade(patchId, patchFileName, mergePackageFlag, isUpgrade);
    }
    ...
    public AjaxResult upgradePatch(Long patchId, String patchFileName, String mergePackageFlag, String isUpgrade, String patchFileUrl) throws Exception {
        return upPatchClientService.upgradePatch(patchId, patchFileName, mergePackageFlag, isUpgrade, patchFileUrl);
    }
