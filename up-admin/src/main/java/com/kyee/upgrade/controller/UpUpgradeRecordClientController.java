...
public class UpUpgradeRecordClientController extends BaseController
{
    ...
    public TableDataInfo upgradePatchList(UpUpgradeDataDTO dataVo) {
        List<UpPatchClientExtend> upgradePatchList = upUpgradeRecordClientService.getUpgradePatchList(dataVo);
    ...
    public AjaxResult startServer(Integer serverId, String projectId, String productId) {
        ...
        return upUpgradeRecordClientService.startServer(serverId, Integer.valueOf(projectId), Integer.valueOf(productId));
    }
    ...
    public AjaxResult sendPatch(Long patchId, Integer serverId) {
        ...
        return upUpgradeRecordClientService.sendPatch(patchId, serverId);
    }
