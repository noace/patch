...
public class UpUpgradeDataDTO extends BaseEntity {
    ...
    /** 未升级的补丁包数 */
    @Excel(name = "未升级补丁包数")
    private Integer noUpNum;

    /** 未升级补丁包最小时间 */
    @Excel(name = "未升级补丁包最小时间")
    private Date noUpMinTime;

    public Date getNoUpMinTime() {
        return noUpMinTime;
    }

    public void setNoUpMinTime(Date noUpMinTime) {
        this.noUpMinTime = noUpMinTime;
    }

    public Integer getNoUpNum() {
        return noUpNum;
    }

    public void setNoUpNum(Integer noUpNum) {
