...
public interface UpPatchMapper
{
     ...
     * @return
     */
    List<Long> selectSubUpPatchIdListByPatchFileName(@Param("patchFileName") String patchFileName);
     ...
     * @return
     */
    List<UpPatch> getPatchListByStatus(@Param("patch") UpPatch patch, @Param("status") String status);
}
