...
public interface UpProjectProductMapper
{
     ...
     * 根据产品和项目Id修改项目产品
     *
     * @param projectProduct 项目产品
     * @return 结果
     */
    int updateByProductIdAndProjectId(UpProjectProduct projectProduct);

    /**
     * @description：获取非子项目的项目产品
     * @author：DangHangHang
     * @date：2023-08-08
     */
    List<UpProjectProduct> getByProductId(UpProjectDTO projectDTO);

    /*
     * @description：根据产品Id获取子项目
     * @author：DangHangHang
     * @date：2023-08-24
     */
    List<UpProjectProduct> getSubProjectByProductId(Integer productId);
}
