...
import com.kyee.upgrade.common.service.ExecuteSQLCommonService;
...
public class UpgradeDatabaseService {
     ...
     * @param serverId
     */
    public void executeSQL(Long patchId, Integer serverId) throws Exception {
        ...
        try {
            ...
            throw new Exception("脚本执行失败，请查看日志");
        }
        ...
        if ("测试".equals(databaseInfo.getServerType())) {
            ...
            throw new Exception("服务器类型错误,请检查：" + databaseInfo.getServerType());
        }
