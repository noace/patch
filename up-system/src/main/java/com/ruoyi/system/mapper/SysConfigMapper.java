...
public interface SysConfigMapper
{
     ...
     * @return
     */
    public Integer selectPatchedNum(@Param("temp") String value);
    ...
    List<PatchUpgradeInfo> getLastUpgrade();

    List<Map> getOneMonthPublish();

    List<PatchUpgradeInfoOneMonth> getOneMonthPatch();
